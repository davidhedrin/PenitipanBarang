                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div>
                            ...
                            <h3 class="card-title mb-2"><span class="text-info">12 </span><span
                                    style="font-weight:100">Sertifikat</span></h3>
                            <small class="text-primary fw-semibold"><i class="bx bx-up-arrow-alt"></i> 12 Sertifikat baru Minggu ini</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div>
                            ...
                            <small class="text-primary fw-semibold"><i class="bx bx-up-arrow-alt"></i> 12
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div>
                            ...
                            <small class="text-primary fw-semibold"><i class="bx bx-up-arrow-alt"></i> 12 Jemaat baru Minggu ini</small>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div>
                            ...
                            <h3 class="card-title mb-2"><span class="text-info">12</span> Jabatan</h3>
                            <small class="text-primary fw-semibold"><i class="bx bx-up-arrow-alt"></i> 12 Jabatan baru Minggu ini</small>
                        </div>
                        <div class="flex-shrink-0">
