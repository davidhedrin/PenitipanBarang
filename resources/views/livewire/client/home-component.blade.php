<div>
    ...
    <style>
        .pickgradient {
            ...
            background: linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(34,193,195,0) 60%);
        }
    ...
    <div class="hero_area">
        ...
        <section class="slider_section">
            <div class="slider_bg_box">
                <img src="{{ asset('assetc/images/slider-bg.jpg') }}" alt="">
            </div>
                            ...
                            <div class="img_container">
                                <div class="img-box">
                                    <div class="img_box-inner">
                                        <img src="{{ asset('assetc/images/client.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="detail-box">
